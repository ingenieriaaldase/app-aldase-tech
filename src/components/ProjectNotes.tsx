...
export default function ProjectNotes({ notes, workers, currentUserId, currentUserRole, onAdd, onDelete }: ProjectNotesProps) {
                                ...
                                >
                                    ...
                                    {canDelete(note) && (
                                        <button
                                            ...
                                            className="opacity-0 group-hover:opacity-100 transition-opacity text-slate-300 hover:text-red-500 shrink-0 mt-0.5"
                                            title="Eliminar nota"
                                        >
